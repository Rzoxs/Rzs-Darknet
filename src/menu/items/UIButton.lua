...
local SettingsButton = {
    Rectangle = { Y = 0, Width = 400, Height = 33 },
    Text = { X = 8, Y = 3, Scale = 0.26 },
    LeftBadge = { Y = -2, Width = 40, Height = 33 },
    RightBadge = { X = 385, Y = -2, Width = 40, Height = 33 },
    RightText = { X = 420, Y = 4, Scale = 0.35 },
    SelectedSprite = { Dictionary = "commonmenu", Texture = "gradient_nav", Y = 0, Width = 431, Height = 33 },
}
...
function RageUI.Separator(Label)
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() then
            ...
            if CurrentMenu.Pagination.Minimum <= Option and CurrentMenu.Pagination.Maximum >= Option then
                if (Label ~= nil) then
                    RenderText(Label, CurrentMenu.X + SettingsButton.Text.X + 210.0, CurrentMenu.Y + SettingsButton.Text.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, 0, 0.26, 245, 245, 245, 255,1)
                end
                RageUI.ItemOffset = RageUI.ItemOffset + SettingsButton.Rectangle.Height
